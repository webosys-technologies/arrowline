...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="box">
      <div class="box-body">
       <h4 class="text-info text-center">Add New Staff</h4>
          <form name="customerForm" class="form-horizontal row-border" method="POST" action="<?php echo base_url(); ?>staff/add">  
              <div class="box-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label require" for="inputEmail3">
                        ...
                        <div class="col-sm-4">
                          <input type="text" placeholder="<?php echo "Staff" ;?>" class="form-control" id="name" name="name" tabindex="1" onblur='chkEmpty("customerForm","name","Please Enter Name");' >
