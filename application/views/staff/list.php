        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-2 top-left-btn">
                <a href="<?php echo base_url();?>staff/import" class="btn btn-block btn-default btn-flat btn-border-purple"><span class="fa fa-upload"> &nbsp;</span>
                <!-- Import Supplier -->
                <?php echo "Import Staff";?>
                </a>
            </div>
            <?php if(in_array("add_supplier",$user_session)){?>
            <div class="col-md-2 top-right-btn">
                <a href="<?php echo base_url()?>staff/add_staff" class="btn btn-block btn-primary btn-flat btn-border-orange"><span class="fa fa-plus"> &nbsp;</span>
                  <!-- Add Supplier -->
                  <?php echo "Add Staff";?>
                </a>
            </div>
      ...
      <div class="box">
        <div class="box-footer">
          <div class="col-md-4 col-xs-6 border-right">
              <h3 class="bold"><?php echo $staff->total;?></h3>
              <span>
                <!-- Total Supplier -->
                <?php echo "Total Staff";?>
              </span>
          </div>
          <div class="col-md-4 col-xs-6 border-right">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
             ...
             <div class="box-header">
              <a href="<?php echo base_url();?>staff/create_full_csv">
                      ...
                      <tr>
                        ...
                        <?php } ?>
                          ...
                          <td>
                            ...
                            <a title="Edit" class="btn btn-xs btn-primary" href="<?php echo base_url();?>staff/edit_data/<?php echo $value->id;?>" data-tt="tooltip"><span class="fa fa-edit"></span></a>
                            <?php } ?>
                             &nbsp;
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <?php echo $this->lang->line('btn_modal_close');?>
                                       ...
                                       <a title="Delete" class="btn btn-danger" href="<?php echo base_url();?>staff/delete/<?php echo $value->id;?>">
                                       <!-- Delete -->
