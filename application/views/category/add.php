        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-4 top-left-btn">
                <a href="" class="btn btn-block btn-default btn-flat"><span class="fa fa-upload"> &nbsp;</span>
                  <!-- Import Categories -->
                  <?php echo $this->lang->line('lbl_item_category_header');?>
                </a>
            </div>
            ...
            <div class="col-md-4 top-right-btn">
                 <?php if(isset($user_session)){
                  ...
                  ?>
                <a href="javascript:void(0)" data-toggle="modal" data-target="#add-category" class="btn btn-block btn-primary btn-flat"><span class="fa fa-plus"> &nbsp;</span>
                    <!-- Add New Category -->
                          ...
                          <td><?php echo $row->unit_name;?></td>
                           ...
                           <td>
                            <?php if(isset($user_session)){
                              ...
                              ?>
                              <a title="message.form.edit" href="<?php echo base_url();?>category/update/<?php echo $row->id;?>" class="btn btn-xs btn-primary edit-unit"><span class="fa fa-edit"></span></a> &nbsp;
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <a href="<?php echo base_url();?>category/delete/<?php echo $row->id;?>" class="btn btn-danger" >Delete</a>
      ...
      <div class="modal-body">
        <form action="<?php echo base_url();?>category/add" method="post" id="myform1" class="form-horizontal" name=categoryForm>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label require" for="inputEmail3">Category
                <span class="text-danger">*</span>
            </label>

            <div class="col-sm-6">
              <input type="text" placeholder="Category" class="form-control" name="category" value="<?php echo set_value('category');?>" id="category">
              <span id="category" style="color: red"><?php echo form_error('category');?></span>
              <p style="color:#990000;"></p>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label require" for="inputEmail3">Units
                <span class="text-danger">*</span>
            </label>

            <div class="col-sm-6">
              <select class="form-control valdation_select" name="units" value="<?php echo set_value('units'); ?>">
                  <span id="name" style="color: red">
                  <?php echo form_error('units');?></span>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <a href="<?php echo base_url();?>category/" class="btn btn-info btn-flat" data-dismiss="modal">Cancle</a>
