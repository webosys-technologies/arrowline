...
?>
  ...
  <div class="content-wrapper">
    <section class="content">
      ...
      <form name="customerForm" class="form-horizontal row-border" method="post" action="<?php echo base_url(); ?>Management/update" >
            <div class="box-footer">
                    ...
                    <div class="row">
                       <div class="col-md-12">
                        ...
                        <label class="col-sm-4 control-label require" for="followup">Follow Up</label>
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="followup" value="<?php echo $data->follow;?>" name="followup">
                                <span style="color: red;"></span>
                                <span style="font-size:20px;"></span>
                                <p style="color:#990000;"></p>
                            </div>
                        ...
                        <label class="col-sm-4 control-label require" for="nextfollow">Next Follow</label>
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="nextfollow" value="<?php echo $data->nextfollow;?>" name="nextfollow" tabindex="4">
                                <span style="color: red;"></span>
                                <span style="font-size:20px;"></span>
                                <p style="color:#990000;"></p>
                            </div>
                        ...
                        <label class="col-sm-4 control-label require" for="nextfollow">Remark</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="remark" value="<?php echo $data->remark;?>" name="remark" tabindex="4">
                                <span style="color: red;"></span>
                                <span style="font-size:20px;"></span>
                                <p style="color:#990000;"></p>
                            </div>
