      ...
      <div class="row">
        <div class="col-md-12">
          <!-- Horizontal Form -->
            ...
            <form action="<?php echo base_url();?>Management/add_status"  method="post" class="form-horizontal" enctype="multipart/form-data" name="transferForm">
...
<!--                   <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="control">
                        <input type="text" class="form-control" name="description" id="desc" placeholder="<?php echo $this->lang->line('lbl_addtransfer_desc');?>" value="">
