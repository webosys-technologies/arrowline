    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-default">
           <div class="box-body">
              <form action="<?php echo base_url();?>management/add_quotation" method="POST" name="quotation" id="quotation_form">  
                    ...
                    <div class="row">
                              ...
                              <select class="form-control select2" style="" name="state" id="state">
                                <option value="">
                                 ...
                                 <?php foreach ($states as $value) { ?>
                                    ...
                                    <option value="<?php echo $value->id; ?>" <?php if($value->id==$customer_info->state_id){echo "selected";}?> ><?php echo $value->name; ?></option>
                                 <?php }?> 
                              </select>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="2" id="shipping_address" name="shipping_address"><?php if(isset($shipping)){echo $shipping->street;}?></textarea>
                              <p style="color:#990000;"></p>
