       ...
       <?php } ?>
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
              ...
              ?>
              <a class="btn btn-primary btn-flat" style="float: right;" href="<?php echo base_url()?>transfer/view"><i class="fa fa-user-plus"></i>
                 <!-- Add Transfer -->
                 <?php echo $this->lang->line('lbl_btn_addtransfer');?>
                </a>
              <?php }}?>
            </div>
                ...
                <?php foreach ($transfer as $row):?>
                  <tr> 
                    ...
                    <td>
                      ...
                      ?>                        
                        <a title="Edit" class="btn btn-xs btn-primary" href="<?php echo base_url();?>transfer/edit/<?php echo $row->id;?>"><span class="fa fa-edit"></span></a>
                      <?php }} ?>
