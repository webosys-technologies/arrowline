...
<div class="content-wrapper">
  <section class="content">
     <div class="box-footer">
        <h4 class="box-title">
          <!-- Suppliers -->
          <?php echo $this->lang->line('supplier_edit_heading');?>
        </h4>
    </div>
    <br>
    ...
    <div class="box">
       <div class="box-body">
        <h4 class="text-info text-center">
          ...
          <form name="customerForm" class="form-horizontal row-border" method="post" action="<?php echo base_url();?>supplier/edit" >  
            <div class="box-body">
              <div class="row">
                 <div class="col-md-12">
