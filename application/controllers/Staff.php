...
class Staff extends CI_Controller {
    ...
    */
	public function index()
	{
		...
		$data['data'] = $this->Staff_model->staffUserData();
        $data['staff']=$this->Staff_model->getstaff();
        $data['status']=$this->Staff_model->getStatus();
        $data['deactive']=$this->Staff_model->getDeactive();
    ...
    */
	public function add_staff(){
        ...
        $data['country']  = $this->Staff_model->dataCountry();
        $data['state'] = $this->Staff_model->dataState();
        $data['city'] = $this->Staff_model->dataCity();
    ...
    */
	public function add()
    {
        ...
        if ( ($this->form_validation->run() == true) && $this->Staff_model->addStaff($staff))
        {
    ...
    */
	public function delete($id)
    {
    	...
    	if($this->Staff_model->deleteStaff($del))
        {
    ...
    {	  
        ...
        $data['data'] = $this->Staff_model->editData($id);
       ...
       /* echo "country_id".$state_id;
        exit();*/
        $data['country']=$this->Staff_model->dataCountry();
        $data['state'] = $this->Staff_model->getStateByID($count_id);
        $data['city'] = $this->Staff_model->getCityByID($state_id);
    ...
    { 
        ...
        if ( ($this->form_validation->run() == true) && $this->Staff_model->editStaff($staff))
        {
